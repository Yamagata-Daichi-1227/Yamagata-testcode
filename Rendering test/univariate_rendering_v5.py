...
def curv(path_k1,path_k2):
    ...
    save_Nifti_data(arr, imgk1.affine, 'output/20210825/gauss_5_3.5.nii.gz')
...
#curv('output/20210825/aoi_curv_k1_5_3.5.nii.gz','output/20210825/aoi_curv_k2_5_3.5.nii.gz')
...
reader.SetFileName('input/case005_AOI.nii.gz')
reader.Update()
...
curvature.SetFileName("output/20210825/gauss_5_3.5.nii.gz")
#curvature.SetFileName("output/20210825/mean_5_3.5.nii.gz")
...
#------------------------------------------------------------------
dim = np.power(2,13)#12乗(guassの場合)
#dim = np.power(2,4)#4乗(meanの場合)
r = (fmax-fmin)/dim
